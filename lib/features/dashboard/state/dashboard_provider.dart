...
class DashboardNotifier extends StateNotifier<DashboardState> {
  ...
  Future<void> createTrainingPlan(String name) async {
    try {
      ...
      final response = await api.createTrainingPlan(name);
      final newPlanId = response['id']?.toString();
      ...
      ref.read(activePlanIdProvider.notifier).state = newPlanId;

      await loadFolders(newPlanId);
